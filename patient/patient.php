...
.covid h2{
	...
	<body>
		...
		<!-- navigation -->
		<nav class="navbar  " role="navigation" style="background-color:black;padding:10px;">
					...
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							<div class="input-group" style="margin-bottom:10px;">
								...
								<input class="form-control cal" id="date" name="date" value="<?php echo date("Y-m-d")?>" onchange="showUser(this.value)"/>
							</div>
						</div>
						<!-- date textbox end -->
						<!-- script start -->
        ...
        <div class="mb-5 ml-5 flex-center">
          ...
          <!-- Facebook -->
          <a class="fb-ic">
            <i class="fa fa-facebook fa-lg white-text mr-5 fa-2x" style="margin-left:15px;margin-bottom:10px;"> </i>
          </a>
          <!-- Twitter -->
          <a class="tw-ic">
            <i class="fa fa-twitter fa-lg white-text  mr-5 fa-2x" style="margin-left:15px;"> </i>
          </a>
          
          <!--Linkedin -->
          <a class="li-ic">
            <i class="fa fa-linkedin-in fa-lg white-text  mr-5 fa-2x" style="margin-left:15px;"> </i>
          </a>
          <!--Instagram-->
          <a class="ins-ic">
            <i class="fa fa-instagram fa-lg white-text  mr-5 fa-2x" style="margin-left:15px;"> </i>
          </a>
